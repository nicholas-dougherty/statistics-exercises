...
#|-----------------------------------------------------------------------------------------------------------|
             ...
             #  ▀▀▀▀▀▀▀▀▀▀▀       ▀       ▀         ▀       ▀       ▀▀▀▀▀▀▀▀▀▀▀          #
             #                                                                           #
             # According to a saying credited to Lord Beaconsfield,                      #
             #  there are three kinds of mendacity—lies, damned lies, and statistics.    #
             #----------------------------------------------------------------------------
             #----------------------------------------------------------------------------
             #############################################################################
...
#|-----------------------------------------------------------------------------------------------------------|
# assign the variable through which the subsequent UDF shall be based
